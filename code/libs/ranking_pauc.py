...
import os
LINUX = os.sys.platform != 'darwin'
# different imports for linux and mac os
if LINUX:
    from sklearn.metrics.base import UndefinedMetricWarning
    from sklearn.utils.fixes import bincount, array_equal

else: # MacOS, sklearn.__version__ > 18
    from sklearn.utils.extmath import stable_cumsum
    from sklearn.exceptions import UndefinedMetricWarning
    from numpy import bincount, array_equal
...
def _binary_clf_curve(y_true, y_score, pos_label=None, sample_weight=None):
    ...
    # Philip: different for server (sklearn 17.0) and local (sklearn > 18.1)
    if LINUX:
        # accumulate the true positives with decreasing threshold
